...
public enum StandardActions implements Action {
    ...
    MOVE_FILE_TO_FOLDER(Localization.lang("Move file(s) to next file directory"), IconTheme.JabRefIcons.MOVE_TO_FOLDER),
    MOVE_FILE_TO_FOLDER_AND_RENAME(Localization.lang("Move file to next file directory and rename file")),
